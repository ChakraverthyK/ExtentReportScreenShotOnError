...
public class FreeCRMTest {
	...
	public void setExtent(){
		...
		extent.addSystemInfo("Host Name", "Chakraverthy Windows10");
		extent.addSystemInfo("User Name", "Sample Extent Report with Screenshot On error");
	...
	public void tearDown(ITestResult result) throws IOException{
		...
		if(result.getStatus()==ITestResult.FAILURE){
			...
			String screenshotPath = FreeCRMTest.takeScreenshotAtEndOfTest();
